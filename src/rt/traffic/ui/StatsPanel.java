 ...
 *
 * Gedanke dahinter:
 * - Die GUI hat links die Map, oben die Buttons, und rechts diese kompakte "Info-Spalte".
...
public class StatsPanel extends JPanel {
    ...
    // Wir ändern später nur den Text (setText), die Labels bleiben dieselben Objekte.
     ...
     *
     * Warum String.format:
     * - Wir begrenzen auf 2 Nachkommastellen, damit es ruhig aussieht und nicht "flackert".
     */
